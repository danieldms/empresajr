function Controller() {
    ...
    $.__views.menuNavView.add($.__views.__alloyId34);
    ...
    $.__views.consultoriafinanceira.add($.__views.__alloyId39);
    ...
    $.__views.sub_mkt.add($.__views.__alloyId44);
    ...
    $.__views.planomkt.add($.__views.__alloyId45);
    ...
    $.__views.sub_mkt.add($.__views.__alloyId46);
    ...
    $.__views.pesquisamkt.add($.__views.__alloyId47);
    ...
    $.__views.estudomkt.add($.__views.__alloyId49);
    ...
    $.__views.sub_mkt.add($.__views.__alloyId51);
    ...
    $.__views.negociosmkt.add($.__views.__alloyId52);
    ...
    $.__views.organizacional.add($.__views.__alloyId55);
    $.__views.img = Ti.UI.createImageView({
        width: 10,
        height: 6,
        left: 10,
    ...
    $.__views.sobre.add($.__views.__alloyId58);
    ...
    $.__views.sac.add($.__views.__alloyId62);
    ...
    $.__views.mapa.add($.__views.__alloyId66);
    ...
    $.__views.menuContentView.add($.__views.__alloyId68);
    ...
    $.__views.faleconosco.add($.__views.__alloyId70);
    ...
    $.__views.index.add($.__views.__alloyId74);
